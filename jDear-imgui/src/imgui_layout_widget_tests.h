...
namespace ImGui
{
    ...
    inline void example01(const char* name) {
        ...
        ImGui::Button("Outside Begin", ImVec2(ImLayout::MATCH_PARENT, 0));
        {
            ImGui::BeginCollapseLayout("Title", &isOpen, ImLayout::MATCH_PARENT, ImLayout::WRAP_PARENT);
            if (isOpen)
                renderContent(false);
    ...
    inline void example02(const char* name) {
        ...
        ImGui::Button("Outside Begin", ImVec2(150, 0));
        {
            ImGui::BeginCollapseLayout("Left", &isOpen, 150, ImLayout::WRAP_PARENT);
            if (isOpen) {
                //ImGui::ShowLayoutDebug();
                renderContent(false);
            }
            ...
            ImGui::BeginCollapseLayout("Right", &isOpen2, 150, ImLayout::WRAP_PARENT);
            if (isOpen2) {

                renderContent(false);

                ImGui::BeginCollapseLayout("Child", &isOpen3, ImLayout::MATCH_PARENT, 120);
    ...
    inline void example03(const char* name) {
        ...
        ImGui::Button("Outside Begin", ImVec2(ImLayout::MATCH_PARENT, 0));
        {
            ...
            options.customFrameLayout = true;
            ImGui::BeginCollapseLayout("Left", &isOpen, ImLayout::MATCH_PARENT, ImLayout::WRAP_PARENT, options);
            ...
            ImGui::EndCollapseFrameLayout(options);
            if(isOpen) {
                renderContent(false);
            }
            ImGui::EndCollapseLayout();
