...
bool ImLayout::PrepareCollapseLayout(const char* title, float sizeX, float sizeY, ImGuiCollapseLayoutOptions options)
{
	...
	ImLayout::BeginLayout("frame", ImLayout::MATCH_PARENT, frameHeight, ImGuiLayoutOptions(0, 0, 0, 0));
...
void ImLayout::BeginCollapseLayoutEx(const char* id, bool* isOpen, const char* title, float sizeX, float sizeY, ImGuiCollapseLayoutOptions options)
{
...
bool ImLayout::BeginCollapseLayoutEx(int id, const char* title, float sizeX, float sizeY, ImGuiCollapseLayoutOptions options)
{
	ImLayout::BeginLayoutEx(id);
	return ImLayout::PrepareCollapseLayout(title, sizeX, sizeY, options);
}
...
void ImLayout::BeginCollapseLayout(const char* id, bool* isOpen, const char* title, float sizeX, float sizeY, ImGuiCollapseLayoutOptions options)
{
	ImLayout::BeginCollapseLayoutEx(id, isOpen, title, sizeX, sizeY, options);
	ImLayout::EndCollapseFrameLayout();
}
...
void ImLayout::EndCollapseFrameLayout()
{
	...
	ImLayout::BeginLayout("content", ImLayout::MATCH_PARENT, ImLayout::WRAP_PARENT, ImGuiLayoutOptions(paddingLeft, paddingRight, paddingTop, paddingBottom));
