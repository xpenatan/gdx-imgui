...
//			return true;
	...
	private static int getImGuiKey(int gdxKey) {
		switch (gdxKey)
		{
			...
			case Keys.PAGE_UP: return ImGuiKey.PageUp;
			case Keys.PAGE_DOWN: return ImGuiKey.PageDown;
			case Keys.HOME: return ImGuiKey.Home;
			case Keys.END: return ImGuiKey.End;
			case Keys.INSERT: return ImGuiKey.Insert;
			case Keys.FORWARD_DEL: return ImGuiKey.Delete;
			...
			case Keys.EQUALS: return ImGuiKey.Equal;
			case Keys.LEFT_BRACKET: return ImGuiKey.LeftBracket;
			case Keys.BACKSLASH: return ImGuiKey.Backslash;
			case Keys.RIGHT_BRACKET: return ImGuiKey.RightBracket;
			case Keys.GRAVE: return ImGuiKey.GraveAccent;
			case Keys.CAPS_LOCK: return ImGuiKey.CapsLock;
			case Keys.SCROLL_LOCK: return ImGuiKey.ScrollLock;
			case Keys.NUM_LOCK: return ImGuiKey.NumLock;
			case Keys.PRINT_SCREEN: return ImGuiKey.PrintScreen;
			case Keys.PAUSE: return ImGuiKey.Pause;
			case Keys.NUMPAD_0: return ImGuiKey.Keypad0;
			case Keys.NUMPAD_1: return ImGuiKey.Keypad1;
			case Keys.NUMPAD_2: return ImGuiKey.Keypad2;
			case Keys.NUMPAD_3: return ImGuiKey.Keypad3;
			case Keys.NUMPAD_4: return ImGuiKey.Keypad4;
			case Keys.NUMPAD_5: return ImGuiKey.Keypad5;
			case Keys.NUMPAD_6: return ImGuiKey.Keypad6;
			case Keys.NUMPAD_7: return ImGuiKey.Keypad7;
			case Keys.NUMPAD_8: return ImGuiKey.Keypad8;
			case Keys.NUMPAD_9: return ImGuiKey.Keypad9;
			case Keys.NUMPAD_DOT: return ImGuiKey.KeypadDecimal;
			case Keys.NUMPAD_DIVIDE: return ImGuiKey.KeypadDivide;
			case Keys.NUMPAD_MULTIPLY: return ImGuiKey.KeypadMultiply;
			case Keys.NUMPAD_SUBTRACT: return ImGuiKey.KeypadSubtract;
			case Keys.NUMPAD_ADD: return ImGuiKey.KeypadAdd;
			case Keys.NUMPAD_ENTER: return ImGuiKey.KeypadEnter;
			case Keys.NUMPAD_EQUALS: return ImGuiKey.KeypadEqual;
			case Keys.SHIFT_LEFT: return ImGuiKey.LeftShift;
			case Keys.CONTROL_LEFT: return ImGuiKey.LeftCtrl;
			case Keys.ALT_LEFT: return ImGuiKey.LeftAlt;
			case Keys.SYM: return ImGuiKey.LeftSuper;
			case Keys.SHIFT_RIGHT: return ImGuiKey.RightShift;
			case Keys.CONTROL_RIGHT: return ImGuiKey.RightCtrl;
			case Keys.ALT_RIGHT: return ImGuiKey.RightAlt;
//			case Keys.SYM: return ImGuiKey.RightSuper;
			case Keys.MENU: return ImGuiKey.Menu;
			case Keys.NUM_0: return ImGuiKey.NUM_0;
			case Keys.NUM_1: return ImGuiKey.NUM_1;
			case Keys.NUM_2: return ImGuiKey.NUM_2;
			case Keys.NUM_3: return ImGuiKey.NUM_3;
			case Keys.NUM_4: return ImGuiKey.NUM_4;
			case Keys.NUM_5: return ImGuiKey.NUM_5;
			case Keys.NUM_6: return ImGuiKey.NUM_6;
			case Keys.NUM_7: return ImGuiKey.NUM_7;
			case Keys.NUM_8: return ImGuiKey.NUM_8;
			case Keys.NUM_9: return ImGuiKey.NUM_9;
