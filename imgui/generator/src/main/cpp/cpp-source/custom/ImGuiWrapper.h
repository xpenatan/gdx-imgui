...
//        static bool BeginChild2(ImGuiID id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0) { return im::BeginChild(id, size, border, flags); }
...
//        static void SetWindowPos2(const char* name, const ImVec2& pos, ImGuiCond cond = 0) { im::SetWindowPos(name, pos, cond); }
//        static void SetWindowSize2(const char* name, const ImVec2& size, ImGuiCond cond = 0) { im::SetWindowSize(name, size, cond); }
//        static void SetWindowCollapsed2(const char* name, bool collapsed, ImGuiCond cond = 0) { im::SetWindowCollapsed(name, collapsed, cond); }
...
//        static void PushStyleColor2(ImGuiCol idx, const ImVec4& col) { im::PushStyleColor(idx, col); }
...
//        static void PushStyleVar2(ImGuiStyleVar idx, const ImVec2& val) { im::PushStyleVar(idx, val); }
...
//        static ImU32 GetColorU322(const ImVec4& col) { return im::GetColorU32(col); }
//        static ImU32 GetColorU323(ImU32 col) { return im::GetColorU32(col); }
...
//        static void PushID2(const char* str_id_begin, const char* str_id_end) { im::PushID(str_id_begin, str_id_end); }
//        static void PushID3(const void* ptr_id) { im::PushID(ptr_id); }
//        static void PushID4(int int_id) { im::PushID(int_id); }
//        static void PopID() { im::PopID(); }
//        static ImGuiID GetID(const char* str_id) { return im::GetID(str_id); }
//        static ImGuiID GetID2(const char* str_id_begin, const char* str_id_end) { return im::GetID(str_id_begin, str_id_end); }
//        static ImGuiID GetID3(const void* ptr_id) { return im::GetID(ptr_id); }
//
...
//        static bool CheckboxFlags2(const char* label, unsigned int* flags, unsigned int flags_value) { return im::CheckboxFlags(label, flags, flags_value); }
//        static bool RadioButton(const char* label, bool active) { return im::RadioButton(label, active); }
//        static bool RadioButton2(const char* label, int* v, int v_button) { return im::RadioButton(label, v, v_button); }
...
//            im::Image(user_texture_id, size, uv0, uv1, tint_col, border_col);
//        }
...
//            return im::ImageButton(str_id, user_texture_id, size, uv0, uv1, bg_col, tint_col);
//        }
//
...
//            return im::DragFloatRange2(label, v_current_min, v_current_max, v_speed, v_min, v_max, format, format_max, flags);
//        }
...
//        static bool TreeNode2(const char* str_id, const char* fmt) { return im::TreeNode(str_id, fmt); }
//        static bool TreeNode3(const void* ptr_id, const char* fmt) { return im::TreeNode(ptr_id, fmt); }
//        static bool TreeNodeV(const char* str_id, const char* fmt, va_list args) { return im::TreeNodeV(str_id, fmt, args); }
//        static bool TreeNodeV2(const void* ptr_id, const char* fmt, va_list args) { return im::TreeNodeV(ptr_id, fmt, args); }
//        static bool TreeNodeEx(const char* label, ImGuiTreeNodeFlags flags = 0) { return im::TreeNodeEx(label, flags); }
//        static bool TreeNodeEx2(const char* str_id, ImGuiTreeNodeFlags flags, const char* fmt) { return im::TreeNodeEx(str_id, flags, fmt); }
//        static bool TreeNodeEx3(const void* ptr_id, ImGuiTreeNodeFlags flags, const char* fmt) { return im::TreeNodeEx(ptr_id, flags, fmt); }
...
//        static bool TreeNodeExV2(const void* ptr_id, ImGuiTreeNodeFlags flags, const char* fmt, va_list args) { return im::TreeNodeExV(ptr_id, flags, fmt, args); }
//        static void TreePush(const char* str_id) { im::TreePush(str_id); }
//        static void TreePush2(const void* ptr_id) { im::TreePush(ptr_id); }
...
//        static bool CollapsingHeader2(const char* label, bool* p_visible, ImGuiTreeNodeFlags flags = 0) { return im::CollapsingHeader(label, p_visible, flags); }
...
//        static bool Selectable2(const char* label, bool* p_selected, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0)) { return im::Selectable(label, p_selected, flags, size); }
//
...
//        static void Value2(const char* prefix, int v) { im::Value(prefix, v); }
//        static void Value3(const char* prefix, unsigned int v) { im::Value(prefix, v); }
//        static void Value4(const char* prefix, float v, const char* float_format = NULL) { im::Value(prefix, v, float_format); }
//
...
//        static bool MenuItem2(const char* label, const char* shortcut, bool* p_selected, bool enabled = true) { return im::MenuItem(label, shortcut, enabled); }
//
...
//        static void OpenPopup2(ImGuiID id, ImGuiPopupFlags popup_flags = 0) { im::OpenPopup(id, popup_flags); }
...
//        static ImDrawList* GetBackgroundDrawList2(ImGuiViewport* viewport) { return im::GetBackgroundDrawList(viewport); }
//        static ImDrawList* GetForegroundDrawList2(ImGuiViewport* viewport) { return im::GetForegroundDrawList(viewport); }
//
//        static bool IsRectVisible(const ImVec2& size) { return im::IsRectVisible(size); }
//        static bool IsRectVisible2(const ImVec2& rect_min, const ImVec2& rect_max) { return im::IsRectVisible(rect_min, rect_max); }
...
//            im::ColorConvertRGBtoHSV(r, g, b, out_h2, out_s2, out_v2);
//        }
//        static void ColorConvertHSVtoRGB(float h, float s, float v, float* out_r, float* out_g, float* out_b) {
//            float & out_r2 = *out_r;
//            float & out_g2 = *out_g;
//            float & out_b2 = *out_b;
//            im::ColorConvertHSVtoRGB(h, s, v, out_r2, out_g2, out_b2);
//        }
//
