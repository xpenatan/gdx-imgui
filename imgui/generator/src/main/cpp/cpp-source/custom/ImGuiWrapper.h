...
//        static bool CheckboxFlags_2(const char* label, unsigned int* flags, unsigned int flags_value) { return im::CheckboxFlags(label, flags, flags_value); }
        ...
        static void Image(int user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0)) {
            im::Image((ImTextureID)user_texture_id, size, uv0, uv1, tint_col, border_col);
        }
        static bool ImageButton(const char* str_id, int user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& bg_col = ImVec4(0, 0, 0, 0), const ImVec4& tint_col = ImVec4(1, 1, 1, 1)) {
            return im::ImageButton(str_id, (ImTextureID)user_texture_id, size, uv0, uv1, bg_col, tint_col);
        }
